	...
	public class TerminalEmulator : Control
	{
		...
		private void ConnectTelnet(string HostName)
		{
			...
			try
			{
				...
				// Create New EndPoint
                System.Net.IPEndPoint iep = new System.Net.IPEndPoint(addr[0], _port);  
		...
		private void ConnectSSH2(string hostname, string username, string password)
		{
            ...
            //s.Connect(new IPEndPoint(IPAddress.Parse("0.0.0.0"), _port));
            s.Connect(new IPEndPoint(ip, _port));
