...
namespace Tests.Validation
{
    ...
    public class ValidationTests
    {
        ...
        public void Favorite_Validate_ReturnsErrors()
        {
            ...
            var results = new FileValidations(TestConnectionManager.Instance).Validate(favorite);
        ...
        private static ValidationStates ValidateDbFavorite()
        {
            ...
            var results = new DbValidations(TestConnectionManager.Instance).Validate(favorite);
            return results;
        }
