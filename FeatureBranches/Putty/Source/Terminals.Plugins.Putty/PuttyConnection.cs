...
namespace Terminals.Plugins.Putty
{
    internal class PuttyConnection : Connection, IConnectionExtra
    {
        ...
        private string GetPuttyArguments()
        {
            IGuardedSecurity resolved = this.ResolveFavoriteCredentials();
            var userName = resolved.UserName;
            var userPassword = resolved.Password;

            var puttyOptions = this.Favorite.ProtocolProperties as PuttyOptions;
        ...
        private void LaunchPutty()
        {
            ...
            puttyProcess.StartInfo.Arguments = GetPuttyArguments();
